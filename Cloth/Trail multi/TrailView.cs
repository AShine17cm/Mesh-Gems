...
namespace Mg.Games
{
    public class TrailView : MonoBehaviour
    {
        ...
        void Awake()
        {
            GameObject goHide = new GameObject("Trail");
        ...
        {                                   //根据参数 初始化
            ...
            //SubMeshDescriptor desc =new SubMeshDescriptor(0, countSeg * 6, MeshTopology.Triangles);
            //desc.vertexCount = countVertex;
...
//            if (trHide == null) return;
//            Gizmos.DrawWireCube(tr.position, Vector3.one * 0.2f);
//            Debug.DrawLine(tr.position, trHide.position);
//        }
//#endif
    }
}